...
git clone https://aur.archlinux.org/ncurses5-compat-libs.git && cd ncurses5-compat-libs/ && makepkg -si --skippgpcheck && cd .. && git clone https://aur.archlinux.org/lib32-ncurses5-compat-libs.git && cd lib32-ncurses5-compat-libs/ && makepkg -si --skippgpcheck && cd .. && git clone https://aur.archlinux.org/aosp-devel && cd aosp-level && makepkg -si --skippgpcheck && cd .. && git clone https://aur.archlinux.org/xml2 && cd xml2 && makepkg -si --skippgpcheck && cd .. && git clone https://aur.archlinux.org/lineageos-devel && cd lineageos-devel/ && makepkg -si --skippgpcheck && cd ..
